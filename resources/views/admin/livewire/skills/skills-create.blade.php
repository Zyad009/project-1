...
<x-model.create title="Add New Skill">
...
{{-- <div class="modal fade" id="createSkillModel" tabindex="-1" style="display: none;" aria-hidden="true" wire:ignore.self>
        ...
        <div class="modal-content">
            ...
            <form wire:submit.prevent='submit'>
                ...
                <div class="modal-footer">
                    ...
                    <x-button.submit name="Save"></x-button.submit>
                </div>
            </form>
        </div>
    </div>
