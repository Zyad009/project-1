            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto py-0">
                        ...
                        <a href="{{route("front.servicies")}}" class="nav-item nav-link @yield("servicies-active")">servicies</a>
                        <a href="{{route("front.projects")}}" class="nav-item nav-link @yield("projects-active")">Projects</a>
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                ...
                                <a href="{{route("front.testmonials")}}" class="dropdown-item">Testimonials</a>
                            </div>
                        </div>
