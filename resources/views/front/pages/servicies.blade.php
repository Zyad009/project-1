...
@section('servicies-active', 'active')



@section('panner-head')
@include('front.layouts.sub-header' ,["pageName" => "Servicies"])
@endsection
            ...
            <div class="owl-carousel testimonial-carousel">
                <div class="testimonial-item bg-light rounded my-4">
                    ...
                    <div class="d-flex align-items-center">
                        <img class="img-fluid flex-shrink-0 rounded-circle" src="{{asset("
                            front/assets")}}/img/testimonial-1.jpg" style="width: 65px; height: 65px;">
                        <div class="ps-4">
                ...
                <div class="testimonial-item bg-light rounded my-4">
                    ...
                    <div class="d-flex align-items-center">
                        <img class="img-fluid flex-shrink-0 rounded-circle" src="{{asset("
                            front/assets")}}/img/testimonial-2.jpg" style="width: 65px; height: 65px;">
                        <div class="ps-4">
                            <h5 class="mb-1">Client Name</h5>
                            <span>Profession</span>
                        </div>
                ...
                <div class="testimonial-item bg-light rounded my-4">
                    ...
                    <div class="d-flex align-items-center">
                        <img class="img-fluid flex-shrink-0 rounded-circle" src="{{asset("
                            front/assets")}}/img/testimonial-3.jpg" style="width: 65px; height: 65px;">
                        <div class="ps-4">
                            <h5 class="mb-1">Client Name</h5>
                            <span>Profession</span>
                        </div>
